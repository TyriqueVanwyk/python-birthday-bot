...
if __name__ == '__main__':
    ...
    # Register the drive
    Firefox_browser = webdriver.Firefox(executable_path='<Driver Path>',
    ...
    for user_name in user_name_list:
        ...
        message_box = Firefox_browser.find_element_by_xpath('//div[@class="_13mgZ"]')
        message_box.send_keys('Hey, I am your whatsapp bot')

        # Click on send button
        message_box = Firefox_browser.find_element_by_xpath('//button[@class="_3M-N-"]')
        message_box.click()
